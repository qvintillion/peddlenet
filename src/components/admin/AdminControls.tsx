...
export function AdminControls({ onBroadcast, onClearRoom, onWipeDatabase }: AdminControlsProps) {
  ...
  // Quick action templates - Only Welcome and Maintenance
  const quickActions = [
    {
      label: '🎠 Welcome',
              ...
              <div className="flex gap-2">
                {quickActions.map((action, index) => (
                  <button
                    ...
                    className="bg-blue-600/20 hover:bg-blue-600/30 px-3 py-2 rounded-lg text-xs transition-colors flex-1"
